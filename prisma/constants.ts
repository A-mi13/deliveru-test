...
export const cards = [
  { imageUrl: "/1.png", alt: "Image 1", content: "Контент для изображения 1", link: "/page1" },
  { imageUrl: "/2.png", alt: "Image 2", content: "Контент для изображения 2" },
  { imageUrl: "/3.png", alt: "Image 3", content: "Контент для изображения 3" },
  { imageUrl: "/4.png", alt: "Image 4", content: "Контент для изображения 4" },
  { imageUrl: "/3.png", alt: "Image 3", content: "Контент для изображения 3" },
  { imageUrl: "/4.png", alt: "Image 4", content: "Контент для изображения 4" },
];

export const banners = {
  imageUrl: "/banner.png", // Укажи путь к изображению
  content: "Самые вкусные блюда у нас!",
  alt: "Image 3", // Описание баннера
  link: "/popular", // Ссылка для перехода
  isVisible: true,
};
